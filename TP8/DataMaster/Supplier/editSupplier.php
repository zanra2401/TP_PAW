  ...
  <div class="container">
    ...
    <form action="" method="POST">
      <div class="form-group">
        ...
        <input type="text" id="nama" name="nama" value="<?= isset($_POST["nama"]) ? $_POST["nama"] : getDataSupplier(DB, 'nama', $_GET['id']) ?>">
        <p style="color: red;"><?php echo (isset($errors["nama"])) ? $errors["nama"] : ""  ?></p>
      </div>
      <div class="form-group">
        <label for="telp">Telp</label>
        <input type="text" id="telp" name="telp" value="<?= isset($_POST["telp"]) ? $_POST["telp"] : getDataSupplier(DB, 'telp', $_GET['id']); ?>">
        <p style="color: red;"><?php echo (isset($errors["telp"])) ? $errors["telp"] : "" ?></p>
      </div>
      <div class="form-group">
        <label for="alamat">Alamat</label>
        <input type="text" id="alamat" name="alamat" value="<?= isset($_POST['alamat']) ? $_POST['alamat'] : getDataSupplier(DB, 'alamat', $_GET['id']) ?>">
